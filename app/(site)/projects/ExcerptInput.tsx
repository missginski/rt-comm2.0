  ...
  return (
    <Stack space={3}>
      ...
      <Flex gap={2} align="center" wrap="wrap">
        <Button
          text={value ? "Regenerate from description" : "Generate from description"}
          mode="ghost"
          onClick={() => {
      ...
      {!generated ? (
        <Text size={1} muted>
          Add some text in “Project Description” to enable the generate button.
        </Text>
      ) : (
        <Text size={1} muted>
          Generates from “Project Description” (collapsed whitespace, trimmed to{" "}
          {maxLength} chars).
        </Text>
      )}
    </Stack>
